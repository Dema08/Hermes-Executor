...
namespace Hermes_Executor.Views
{
    ...
    public partial class ScriptEditor : UserControl
    {
        ...
        public TabControl? TabsControl => (FindName("Tabs") as TabControl) ?? Tabs;
        public Button? BtnExecuteControl => (FindName("BtnExecute") as Button) ?? BtnExecute;
        ...
        public ScriptEditor()
        {
            ...
            var btn = BtnExecuteControl;
            if (btn != null)
            {
                btn.Click += (s, e) => ExecuteClicked?.Invoke(s, e);
            }

            TabsList.CollectionChanged += TabsList_CollectionChanged;
            if (TabsControl != null)
            {
                TabsControl.ItemsSource = TabsList;
            }
        ...
        {
            var tabControl = TabsControl;
            if (tabControl != null && TabsList.Count > 1)
            {
                int nextIndex = (tabControl.SelectedIndex + 1) % TabsList.Count;
        ...
        public void SelectPreviousTab()
        {
            ...
            if (tabControl != null && TabsList.Count > 1)
            {
                int prevIndex = (tabControl.SelectedIndex - 1 + TabsList.Count) % TabsList.Count;
        ...
        public string GetText() => GetScriptText();
        ...
        public void SetText(string text) => SetScriptText(text);
